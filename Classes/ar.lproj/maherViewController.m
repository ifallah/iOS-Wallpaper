...
-(void)displayComposerSheet 
{
	MFMailComposeViewController *picker = [[MFMailComposeViewController alloc] init];
		...
		[picker setSubject:@" خلفية لجهازك"];
...
- (IBAction)uploadImage {
	...
	NSData *imageData = UIImageJPEGRepresentation(image.image, 90);
		//self.image.allowsEditing = YES;
	// setting up the URL to post to
		
		

	NSString *urlString = @"http://www.dev-wd.com/iphone/all/photos/up.php";
	...
	if([returnString isEqualToString:@"SUCCESS"])
	{
		...
		if ([MinuPhotoChangToEN isHidden]){
			UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"تم نشر الخلفية بنجاح !" message:@"تم اضافة خلفيتك في معرض الخلفيات المتبادلة" delegate:self cancelButtonTitle:@"موافق" otherButtonTitles:nil];
			[alert show];
			[alert release];
		}else {
			UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Thank you!" message:@"Your background has been published successfully" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
			[alert show];
			[alert release];
		...
		//[self addSubview:ForUpLaodingAR];
	...
	/*
	UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"No Internet Connection!!" message:@"Make sure you are connected to the Internet and it works" delegate:self cancelButtonTitle:@"موافق" otherButtonTitles:nil];
	[alert show];
	[alert release]; }
...
[SheredWebWindowAR loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://www.dev-wd.com/iphone/all/1ENindex.php"]]];	
	}
...
- (IBAction)forloodEN:(id)sender{
    ...
    [SheredWebWindowEN loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://www.dev-wd.com/iphone/all/1ENindex.php"]]];
}
